...
# ----------------------------------------
# If accumulator1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 20.1 720 win32 2024.12.31.20:46:05
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "accumulator1"
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/accumulator1.vhd"         
}
