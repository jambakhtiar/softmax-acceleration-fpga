...
# ACDS 20.1 720 win32 2024.12.31.20:48:19
# ----------------------------------------
...
# ----------------------------------------
# If reciprocal1 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "reciprocal1"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/reciprocal1_memoryC0_uid73_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/reciprocal1_memoryC0_uid74_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/reciprocal1_memoryC1_uid77_inverseTables_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/reciprocal1_memoryC2_uid80_inverseTables_lutmem.hex ./
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/reciprocal1.vo"
}
