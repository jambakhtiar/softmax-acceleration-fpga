...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/reciprocal1_memoryC0_uid73_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/reciprocal1_memoryC0_uid74_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/reciprocal1_memoryC1_uid77_inverseTables_lutmem.hex ./
  cp -f $QSYS_SIMDIR/reciprocal1_memoryC2_uid80_inverseTables_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/reciprocal1.vo"
fi
