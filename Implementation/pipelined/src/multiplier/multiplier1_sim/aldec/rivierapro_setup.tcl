...
# ACDS 20.1 720 win32 2024.12.31.20:47:18
# ----------------------------------------
...
# ----------------------------------------
# If multiplier1 is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "multiplier1"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/multiplier1.vo"
}
